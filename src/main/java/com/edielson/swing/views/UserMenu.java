...
public class UserMenu extends JFrame {
	 ...
	 */
	public UserMenu() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserMenu.class.getResource("/com/edielson/images/aH-40px.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(UserMenu.class.getResource("/com/edielson/images/pessoas.png")));
		...
		lblBusquedaDeReservas.setFont(new Font("sansserif", Font.PLAIN, 18));
		btnBuscar.add(lblBusquedaDeReservas);
		
		JLabel logo = new JLabel("");
		logo.setBounds(50, 58, 150, 150);
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(UserMenu.class.getResource("/com/edielson/images/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(UserMenu.class.getResource("/com/edielson/images/reservado.png")));
		labelRegistro.setForeground(SystemColor.text);
		labelRegistro.setBounds(25, 11, 205, 34);
		labelRegistro.setFont(new Font("sansserif", Font.PLAIN, 18));
	    ...
	    labelFecha.setText(fecha); //estabelece a data na label
	    ...
	    String textoDescripcion = "<html><p>Sistema de reservas de hotéis. Controle e gerencie de forma otimizada e fácil o fluxo de reservas e hóspedes do hotel. </p></html>";
	    JLabel labelDescripcion_0 = new JLabel(textoDescripcion);
	    labelDescripcion_0.setFont(new Font("sansserif", Font.PLAIN, 17));
	   
	    labelDescripcion_0.setBounds(312, 291, 598, 66);
	    contentPane.add(labelDescripcion_0);
	    
	    String textoDescricao1 = "<html><p> Esta ferramenta permitirá que você mantenha um controle completo e detalhado de suas reservas e hóspedes, você terá acesso a ferramentas especiais para tarefas específicas como:</p></html>";
	    JLabel labelDescricao_1 = new JLabel(textoDescricao1);
	    labelDescricao_1.setFont(new Font("sansserif", Font.PLAIN, 17));
	    ...
	    labelDescricao_2.setFont(new Font("sansserif", Font.PLAIN, 17));
	    ...
	    labelDescricao_3.setFont(new Font("sansserif", Font.PLAIN, 17));
	    ...
	    labelDescricao_4.setFont(new Font("sansserif", Font.PLAIN, 17));
